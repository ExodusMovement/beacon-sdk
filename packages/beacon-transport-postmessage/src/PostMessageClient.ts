import { windowRef, Serializer, getSenderId, MessageBasedClient } from '@exodus/airgap-beacon-core'

import { openCryptobox, secretbox_NONCEBYTES, secretbox_MACBYTES } from '@exodus/airgap-beacon-utils'
import {
  ExtensionMessage,
